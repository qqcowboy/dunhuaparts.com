...
type IViewEngine interface {
	RenderView(controllerName, actionName, theme string, viewData map[string]interface{}, writer io.Writer) error
}
...
func NewDefualtEngine() *DefaultViewEngine {
	e := &DefaultViewEngine{Extension: ".html"}
	e.ViewLocation =
...
func (this *DefaultViewEngine) getViewPath(controllerName, actionName, theme string) string {
	//普通的模板
